...
login.addEventListener('click', () => {
  if (document.getElementById('input-login').value !== 'tryber@teste.com' || document.getElementById('input-senha').value !== '123456') {
...
com.addEventListener('input', () => {
  cou.innerHTML = com.maxLength - com.value.length;
});
